...
public class Sequence extends FactEntity {
    /**
     * If this sequence is the list of arguments to a function, then this is the
     * function, and the sequence will not have a parent. Otherwise, this is
     * null and the sequence will have a parent (unless it's the top-level debug
     * point).
     */
    ...
    /**
     * Sets the function reference for this sequence, and changes all children
     * of this sequence to have the specified function reference as their
     * parent.
     * 
     * @param function
     */
    ...
    public Sequence(List<FactEntity> list) {
    ...
    /**
     * Adds the specified item to this sequence and sets the parent of the
     * specified item to this sequence.
     * 
     * @param entity
     */
