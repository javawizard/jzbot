...
public class HttpServer
{
    ...
    // API parts
    // ==================================================
    private String serverFactoidName;
    ...
    public Response serve(String uri, String method, Properties header, Properties parms)
    {
        try
        {
            ...
            vars.put("http-method", method);
            for (Map.Entry e : header.entrySet())
            {
                vars.put("http-header-" + e.getKey(), "" + e.getValue());
            }
            ...
            if (responseCodeVar != null)
                responseCode = responseCodeMap.get(responseCodeVar);
            if (responseCode == null)
                throw new RuntimeException("No such response code by name: "
                    + responseCodeVar);
            /*
             * Now we'll get the content type.
             */
            String contentType = vars.get("http-content-type");
            if (contentType == null)
                contentType = "text/html";
            /*
             * Now we'll check for a resource.
             */
            ...
            if (resourceName != null
                ...
                throw new RuntimeException(
                        "Invalid resource name (contains invalid characters) "
                            + "generated by the factoid: " + resourceName);
            /*
             * Now we'll create a response.
             */
            Response response;
            if (resourceName == null)
                ...
                response =
                        new Response(responseCode, contentType, new FileInputStream(
        ...
        catch (Throwable e)
        {
            ...
            Response response =
                    new Response(HTTP_INTERNALERROR, "text/plain",
    ...
    static
    {
        responseCodeMap.put("ok", HTTP_OK);
        responseCodeMap.put("redirect", HTTP_REDIRECT);
        responseCodeMap.put("forbidden", HTTP_FORBIDDEN);
        responseCodeMap.put("badrequest", HTTP_BADREQUEST);
        responseCodeMap.put("internalerror", HTTP_INTERNALERROR);
        responseCodeMap.put("notimplemented", HTTP_NOTIMPLEMENTED);
        responseCodeMap.put("notfound", HTTP_NOTFOUND);
    }
    /**
     ...
     */
    public HttpServer(int port, String factoid) throws IOException
    {
        myTcpPort = port;
        serverFactoidName = factoid;
        serverSocket = new ServerSocket(myTcpPort);
        serverThread = new Thread(new Runnable()
        {
            public void run()
            {
                while (JZBot.httpServers.containsValue(HttpServer.this)
                ...
                System.out.println("Exiting http server " + myTcpPort);
            }
        });
    ...
    public static void main(String[] args)
    {
        System.out.println("NanoHTTPD 1.11 (C) 2001,2005-2008 Jarno Elonen\n"
            ...
            + "Modified by Alexander Boyd (javawizard2539/jcp)");
            ...
            boolean allowDirectoryListing)
    {
        ...
        if (f.isDirectory())
        {
            ...
            else if (allowDirectoryListing)
            {
                ...
                for (int i = 0; i < files.length; ++i)
                {
                    ...
                    msg +=
                            "<a href=\"" + encodeUri(uri + files[i]) + "\">" + files[i]
                                + "</a>";
        ...
        try
        {
            ...
            if (dot >= 0)
                mime =
                        (String) theMimeTypes.get(f.getCanonicalPath().substring(dot + 1)
                                .toLowerCase());
            if (mime == null)
     ...
     */
    public static HashMap<String, String> theMimeTypes = new HashMap<String, String>();
    static
    {
        StringTokenizer st =
                new StringTokenizer("htm        text/html " + "html       text/html "
    ...
    private static final String LICENCE =
            "Copyright (C) 2001,2005-2008 by Jarno Elonen <elonen@iki.fi>\n"
                ...
                + "\n"
                + "This copy of NanoHTTPD has been modified by Alexander Boyd (javawizard2539/jcp) "
                + "for use within JZBot.";
    
    private ServerSocket serverSocket;
    
    public String getFactoid()
    {
        return serverFactoidName;
    }
}
