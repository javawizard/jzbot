...
public class Set extends Prepared
{
    ...
    public int update() throws SQLException
    {
        ...
        switch (type)
        {
            ...
            {
                session.getUser().checkAdmin();
                // REMOVED FOR SECURITY REASONS FOR JZBOT BY JAVAWIZARD
                // This used to be:
                ...
                database.setCluster(StringUtils.quoteStringSQL(""));
                addOrUpdateSetting(name, StringUtils.quoteStringSQL(""), 0);
                break;
            }
            case SetTypes.COLLATION:
            {
                ...
                if (table != null)
                {
                    throw Message.getSQLException(
                            ErrorCode.COLLATION_CHANGE_WITH_DATA_TABLE_1, table.getSQL());
                }
